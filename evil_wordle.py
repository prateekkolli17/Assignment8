...
class Keyboard:
    ...
    def update(self, feedback_colors, guessed_word):
        ...
        for i, letter in enumerate(guessed_word):
            ...
            # Update only if the color is NOT_IN_WORD or it's the first color feedback
            if self.colors[letter] == NO_COLOR:
                self.colors[letter] = color
            elif color == CORRECT_COLOR:
                self.colors[letter] = color
    ...
    def __str__(self):
        ...
        for row in rows:
            for letter in row:
                output += color_word(self.colors[letter], letter) + " "
            output += "\n"
        return output
...
class WordFamily:
    ...
    def __init__(self, feedback_colors, words):
        ...
        self.difficulty_score = sum(
    2 if color == NOT_IN_WORD_COLOR else 1 if color == WRONG_SPOT_COLOR else 0
    ...
    def __lt__(self, other):
        ...
        # Compare based on number of words first, then difficulty score, then pattern lexicographically
...
def get_feedback_colors(secret_word, guessed_word):
    ...
    # Second pass for wrong spot letters
    for i in range(5):
...
def get_feedback(remaining_secret_words, guessed_word):
    ...
    # Create WordFamily objects and sort them
    ...
    return hardest_family.pattern, hardest_family.words
